    ...
    <div class="container-fluid">
        ...
        <div class="allcontents bg-white p-2 mt-2">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumblinks">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.events.tours', $Pevent) }}">{{ $Pevent->title }}</a></li>

                    <li class="breadcrumb-item active" aria-current="page">AddTour</li>
                </ol>
            </nav>
            ...
            <div class="bg-white mt-2 pt-3 p-lg-3">
                <form action="{{ route('store.event.tours') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <hr>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                ...
                                @forelse ($events as $event)
                                    <option @if ($event->id == $Pevent->id) selected @endif value="{{ $event->id }}">
                                        {{ $event->title }}</option>
                                @empty
                    ...
                    <div class="prodsubmitbtn">
                        <button class="btn btn-sm orangebg" type="submit">Add Tour</button>
                    </div>
